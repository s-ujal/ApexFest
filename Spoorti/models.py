...
class Team(models.Model):
    ...
    user = models.ForeignKey(Users_INFO, on_delete=models.CASCADE, related_name='created_SpoortiTeams',  default=None, blank=True, null=True)   #for user association with team
...
class TeamMember(models.Model):
    team = models.ForeignKey(Team, on_delete=models.CASCADE, null=True, related_name='team_members')
